/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dad6ff90292cae9662d82ad7d54493bb)
// Runtime types generated with workerd@1.20260910.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	INITIAL_VISITOR_COUNT: "3";
	VISITOR_COUNTER: DurableObjectNamespace<import("./src/index").VisitorCounter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VisitorCounter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INITIAL_VISITOR_COUNT">> {}
}
